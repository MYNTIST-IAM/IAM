...
├── agents/
│   └── agent-ledger.yml        # Central registry of all AI/automated agents
├── scripts/
│   ├── survivability_scoring.py    # Scoring bot that calculates token health
│   ├── detect_agents.py            # Detects agents from GitHub Actions workflows
│   ├── validate_agents.py          # Validates agent-to-token relationships
